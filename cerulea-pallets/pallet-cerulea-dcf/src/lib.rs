//! # pallet-cerulea-dcf
//!
//! This pallet implements the Dynamic Consensus Framework (DCF) for the Cerulea, providing advanced validator management, scoring, and on-chain governance. It supports dynamic validator sets, configurable consensus weights, and robust governance mechanisms for slashing, rewards, and ejection.
//!
//! ## Main Features
...
//! `cerulea-runtime/src/genesis_config_presets.rs`. Available presets include:
//!
...
pub mod pallet {
    ...
    // ValidatorJoinTime and ValidatorLeaveRequests moved to pallet-cerulea-pos.
    ...
    // ValidatorStake and RecentlyRemovedValidators moved to pallet-cerulea-pos.
    ...
    // EpochTotalSlashed and EpochTotalRewarded moved to pallet-cerulea-pos.
    ...
    // ValidatorEpochSlashed and ValidatorEpochRewarded moved to pallet-cerulea-pos.
    ...
    impl<T: Config> Pallet<T> {
        ...
        // direct slashing calls moved to pallet-cerulea-pos.
        ...
        // join_validator_set moved to pallet-cerulea-dvf.
        ...
        pub fn validate_genesis_configuration(
            ...
            match Self::validate_genesis_config(&genesis_config) {
                ...
                Err(error) => {
                    log::error!("============== [CBC-TRACE] 38 [pallet-cerulea-dcf::validate_genesis_configuration] Genesis validation failed: {:?} ==============", error);
        ...
        pub fn dry_run_genesis_configuration(
            ...
            match Self::dry_run_genesis_build(&genesis_config) {
                ...
                Err(error) => {
                    log::error!("============== [CBC-TRACE] 38 [pallet-cerulea-dcf::dry_run_genesis_configuration] Genesis validation failed: {:?} ==============", error);
                    // Emit failure event with error details
        ...
        // cancel_leave_request moved to pallet-cerulea-pos.

        // leave_validator_set moved to pallet-cerulea-dvf.
    ...
    impl<T: Config> Pallet<T> {
        ...
        fn handle_regular_block_processing(block_number: u32, current_epoch: u32) -> Weight {
            ...
            // Cooldown and leave requests are managed by pallet-cerulea-pos.
    ...
    impl<T: Config> BuildGenesisConfig for GenesisConfig<T> {
        fn build(&self) {
            ...
            log::info!("============== [CBC-TRACE] 10.1 [pallet-cerulea-dcf::genesis_build] Genesis block validation started ==============");
            ...
            log::info!("============== [CBC-TRACE] 10.2 [pallet-cerulea-dcf::genesis_build] Genesis configuration loaded ==============");
            ...
            for (i, (((validator, score), stake), name)) in self.validators.iter()
                ...
                log::info!("============== [CBC-TRACE] 10.3.{} [pallet-cerulea-dcf::genesis_build] Genesis validator {} initialized ==============", i + 1, i + 1);
            ...
            log::info!("============== [CBC-TRACE] 10.4 [pallet-cerulea-dcf::genesis_build] PoS scores calculated for all genesis validators ==============");
            
            // STEP 10.5: PoI scores calculated for all genesis validators
            log::info!("============== [CBC-TRACE] 10.5 [pallet-cerulea-dcf::genesis_build] PoI scores calculated for all genesis validators ==============");
            
            // STEP 10.6: Combined DCF scores computed for all validators
            log::info!("============== [CBC-TRACE] 10.6 [pallet-cerulea-dcf::genesis_build] Combined DCF scores computed for all validators ==============");
            ...
            if !self.validators.is_empty() {
                ...
                log::info!("============== [CBC-TRACE] 10.7 [pallet-cerulea-dcf::genesis_build] Deterministic author sequence generated for epoch 0 ==============");
            ...
            log::info!("============== [CBC-TRACE] 10.8 [pallet-cerulea-dcf::genesis_build] Genesis block created ==============");
            ...
            log::info!("============== [CBC-TRACE] 10.9 [pallet-cerulea-dcf::genesis_build] Genesis validation completed successfully ==============");
    ...
    impl<T: Config> Pallet<T> {
        ...
        // execute_slash_validator, execute_slash_validator_with_reason, distribute_rewards, execute_reward_validator, and execute_reward_validator_with_reason moved to pallet-cerulea-pos.
        ...
        // cleanup_recently_removed_validators and process_expired_leave_requests removed because cooldowns are managed by pallet-cerulea-pos.
