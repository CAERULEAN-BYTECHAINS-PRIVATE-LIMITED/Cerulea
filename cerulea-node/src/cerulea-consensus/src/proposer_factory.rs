...
use crate::inherent_providers::CeruleaInherentDataProviders;
    ...
    TP: TransactionPool<Block = B> + 'static,
{
    ...
    inherent_providers: CeruleaInherentDataProviders,
    ...
    TP: TransactionPool<Block = B> + 'static,
{
    ...
    pub fn new(client: Arc<C>, transaction_pool: Arc<TP>, min_block_time: Duration, max_transactions_per_block: usize) -> Self {
        Self {
            client,
            transaction_pool,
            inherent_providers: CeruleaInherentDataProviders::new(),
            min_block_time,
