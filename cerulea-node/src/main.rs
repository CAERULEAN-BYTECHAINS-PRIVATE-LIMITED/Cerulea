...
use clap::Parser;
use cerulea_node::{cli, logging, command, lifecycle_tracer};
    ...
    if cli.lifecycle_trace {
        ...
        let cli_metadata = lifecycle_tracer::TraceMetadata {
            ...
            custom: {
                ...
                map.insert("cerulea_mode".to_string(), cli.cbc_mode.clone());
    ...
    if cli.lifecycle_trace {
        let log_metadata = lifecycle_tracer::TraceMetadata {
            ...
            custom: {
                ...
                map.insert("cerulea_log_only".to_string(), cli.cbc_log_only.to_string());
    ...
    if cli.lifecycle_trace {
        let metadata = lifecycle_tracer::TraceMetadata {
            ...
            custom: {
                ...
                map.insert("chain".to_string(), "Cerulea".to_string());
